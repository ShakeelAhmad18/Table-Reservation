...
const DJBoothGrid = ({djBooth,availableTables,selectReservationData}) => {
  ...
  return (
    <div className="p-6 bg-white">
      <div className="text-black text-lg font-semibold mb-4  text-center">
        DJ Booth
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        {/* Left Column */}
        <div className="lg:col-span-2 justify-center items-center flex flex-col lg:gap-[270px] gap-8 lg:ml-20">
        ...
        {/* Middle Grid */}
        <div className="lg:col-span-8 lg:mt-10 lg:mb-10 lg:ml-48 grid grid-cols-2 lg:grid-cols-2 gap-4">
          {djBooth?.slice(0, 8).map((image, index) => (
            <div
              key={djBooth?.tableId}
              className={`relative cursor-pointer rounded-lg overflow-hidden border-2 ${
                availableTables?.some(
        ...
        {/* Right Column */}
        <div className="lg:col-span-2 justify-center items-center flex flex-col lg:mr-28 gap-8 lg:gap-[270px]">
