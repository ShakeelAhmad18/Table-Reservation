...
const Bar360Grid = ({mainArea,availableTables,selectReservationData}) => {
  ...
  return (
    ...
    <div className="text-black text-lg font-semibold mb-2 text-center">Bar 360</div>
     
    {/* First Row: 4 Images, 4 Columns */}
